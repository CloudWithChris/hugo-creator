...
![Initial View of the Windows Terminal](images/windows-terminal-initial.jpg)
...
For me, the magic behind Windows Terminal is the profiles. You can have multiple tabs open at the same time, and switch between those views. So, easily cycling between PowerShell and Ubuntu or Azure Cloud Shell and a local Windows Command Prompt.
  ...
  >
  > ![Multiple Profiles/Shells within a Tab](images/windows-terminal-multishell-tab.jpg)
...
![Configuring a profile to connect to an Azure Virtual Machine](images/windows-terminal-ssh-connections.jpg)
...
![Listing of .ssh directories in WSL and Windows, showing different keys](images/windows-terminal-ssh-keys.jpg)
